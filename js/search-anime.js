...
function obtenerResultadosConURLs(query) {
  resultadosConURLs = [
    ...
    { resultado: 'Fabulous Beasts', url: '../lista-anime/fabulous-beasts' },
    ...
    { resultado: 'Gachiakuta', url: '../lista-anime/gachiakuta' },
    ...
    { resultado: 'High-Rise Invasion', url: '../lista-anime/high-rise-invasion' },
    ...
    { resultado: 'Kami no Niwatsuki Kusunoki-tei', url: '../lista-anime/kami-no-niwatsuki-kusunoki-tei' },
    ...
    { resultado: 'Look Back', url: '../lista-anime/look-back' },
    { resultado: 'Liar Game', url: '../lista-anime/liar-game' },
    ...
    { resultado: 'Mushoku Tensei: Jobless Reincarnation', url: '../lista-anime/mushoku-tensei-jobless-reincarnation' },
    ...
    { resultado: 'Petals of Reincarnation', url: '../lista-anime/petals-of-reincarnation' },
    ...
    { resultado: 'Sousou no Frieren', url: '../lista-anime/sousou-no-frieren' },
    ...
    { resultado: 'Takopii no Ganzai', url: '../lista-anime/takopii-no-genzai' },
    ...
    { resultado: 'The Strongest Job is Apparently Not a Hero or a Sage, but an Appraiser (Provisional)!', url: '../lista-anime/the-strongest-job-is-apparently-not-a-hero-or-a-sage-but-an-appraiser-provisional' },
